...
void draw_cube()
{
    ...
    //construct side on +x axis//
     ...
     glBegin(GL_LINES);
     glVertex3f(5.0-cubeX, 0.0-cubeY, 0.0-tmpZ);
     glVertex3f(-5.0-cubeX, 0.0-cubeY, 0.0-tmpZ);
     glEnd();
     ...
     glBegin(GL_LINES);
     glVertex3f(0.0-cubeX, 5.0-cubeY, 0.0-tmpZ);
     glVertex3f(0.0-cubeX, -5.0-cubeY, 0.0-tmpZ);
     glEnd();
     glPopMatrix();
     ...
     glBegin(GL_LINES);
     glVertex3f(0.0-cubeX, 0.0-cubeY, 5.0-tmpZ);
     glVertex3f(0.0-cubeX, 0.0-cubeY, -5.0-tmpZ);
     glEnd();
     glPopMatrix();
    ...
    gluLookAt(1.0,3.0,10.0,0.0,0.0,-10.0,0.0,1.0,0.0);
     ...
     draw_cube();
         ...
         glRotatef(360.0-pitch, 1.0, 0.0, 0.0); //x축에 대해 회전
         glRotatef(360.0-yaw, 0.0, 1.0, 0.0); //y축에 대해 회전
         glRotatef(360.0-roll, 0.0, 0.0, 1.0); //z축에 대해 회전
     //좌표축을 그림
     draw_line();
